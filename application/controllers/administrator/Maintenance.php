	...
	class Maintenance extends CI_Controller
		{
			...
			public function service_manage($id){
			...
			$this->AuthenticationModel->checklogin();
					...
					$data = array();
						...
						$data['list_executive']	    =	$this->MaintenanceModel->list_executive();
			...
			$this->load->view('admin/maintenance/create_view_maintenance',$data);
		
		
		
		}
		
		public function user_request_complaint($id)
		{
					   ...
					   if($id == "requests")
					   { 
						$this->load->view('executive/maintenance/user_request',$data);   
					   }
                       if($id == "complaints")
					   {   
