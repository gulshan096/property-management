                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Vendor Category List</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Vendor Category List</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card addform">
                                    <div class="card-body">
										<form onsubmit="return dorequest('<?php echo base_url('administrator/vendor/managevendorcategory'); ?>','.managevendorcategoryfrm','.managevendorcategoryres');" method="POST" class="row managevendorcategoryfrm">
										<h4 class="heading">Create Category</h4>
				
											<input value="<?php echo !empty($category['id'])?$category['id']:0; ?>" name="cat_id" type="hidden" />
											<div class="row">
												<div class="col-md-6">
												<small>&nbsp;</small>
													<div class="mb-3">
														...
														<input value="<?php echo isset($category['category'])?$category['category']:""; ?>" name="category" maxlength="80" type="text" class="form-control"  required/>
													</div>
												</div>
												
												
										
										<div class="managevendorcategoryres" style="clear:both;"></div>
										<div style="clear:both;"></div>
										<div class="col-md-12 mt-2">
											<button class="btn btn-primary" type="submit"><?php echo !empty($category['id'])?"Update Category":"submit"; ?></button>
											<button class="btn btn-outline-danger btn-cancel" type="button"><a class="text-info" href="<?php echo BASE_HTTP_REL_URL; ?>administrator/vendors/category/view">Cancel</a></button>
						...
						?>
									<div style='float: right; margin-bottom: 10px;'>
										<a class="btn btn-success" href="<?php echo base_url('administrator/vendors/category/view/add'); ?>" >Add New Category</a>
									</div>
									<div style='clear:both;'></div>
										...
										<table id="tabeldatahere" class="table table-striped">
											...
											<tbody>
												<?php
													...
													{
														foreach($list_category as $stf)
														{
												?>
															<tr>
																<td><?php echo $stf['category']; ?></td>
																<td><?php echo !empty($stf['status'])?"<button onclick='status(this);' t='vendor_category'   i='id'  v='$stf[id]' s='1' type='button' class='btn btn-success'>Unblock</button>":"<button onclick='status(this);' t='vendor_category' i='id' v='$stf[id]' s='0' type='button' class='btn btn-danger'>Block</button>"; ?></td>
																
																
																<td><a class="fa fa-edit" href="<?php echo base_url("administrator/vendors/category/view/$stf[id]"); ?>"></a></td>
																</td>
															</tr>
												<?php
														}
