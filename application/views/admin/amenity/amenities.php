                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card addform">
                                    <div class="card-body">
										<form onsubmit="return dorequest('<?php echo base_url('administrator/amenities/manageamenity'); ?>','.manageamenityfrm','.manageamenityres');" method="POST" class="row manageamenityfrm">
										<h4 class="heading">Create Amenity</h4>
				
											<input value="<?php echo !empty($amenity['id'])?$amenity['id']:0; ?>" name="id" type="hidden" />
											<div class="row">
												<div class="col-md-6">
													<small>&nbsp;</small>
													<div class="mb-3">
														...
														<input value="<?php echo isset($amenity['amenity'])?$amenity['amenity']:""; ?>" name="amenity" maxlength="80" type="text" class="form-control"  required/>
													</div>
												</div>
												...
												<!--div class="col-md-6" style="margin-top:20px">
													...
													<select class="form-control"  name="userrole">
														...
														$user_role=array('admin','user','staff');
														$i=0;
														while($i<3){
															if(isset($users['userrole']) && $users['userrole']==$user_role[$i]){
										...
										<div class="col-md-6">
											...
											<?php
												$photourl = !empty($amenity['image'])?BASE_URL($amenity['image']):
											...
											<input type="file" value="<?php echo isset($amenity['image'])?$amenity['image']:""; ?>" name="photo_inp" multiple="true" accept="image/*" id="finput" onchange="readURL(this);" class="d-none"/>
										</div>

										
										<div class="manageamenityres" style="clear:both;"></div>
										<div style="clear:both;"></div>
										<div class="col-md-12 mt-2">
											<button class="btn btn-primary" type="submit"><?php echo !empty($amenity['id'])?"Update Amenity":"submit"; ?></button>
										</div>
										</div>
										<div style="clear:both;"></div>
									</form>
						...
						?>
									<div style='float: right; margin-bottom: 10px;'>
										<a class="btn btn-success" href="<?php echo base_url('administrator/amenity/view/add'); ?>" >Add Amenity</a>
									</div>
									<div style='clear:both;'></div>
										...
										<table id="tabeldatahere" class="table table-striped">
											...
											<tbody>
												<?php
													...
													if(!empty($list_amenity))
													{	$i=1;
														foreach($list_amenity as $stf)
														{
												?>
															<tr>
																<td><?php echo $i;?></td>

																<td><?php echo $stf['amenity']; ?></td>
																...
																<td><?php echo !empty($stf['status'])?"<button onclick='updatestatus(this);' t='amenities'   i='id'  v='$stf[id]' s='1' type='button' class='btn btn-success'>block</button>":"<button onclick='updatestatus(this);' t='amenities' i='id'  v='$stf[id]' s='0' type='button' class='btn btn-danger'>unblock</button>"; ?></td>
																
																
																<td><a class="fa fa-edit" href="<?php echo base_url("administrator/amenity/view/$stf[id]"); ?>"></a></td>
																</td>
															</tr>
												<?php
														$i++;
