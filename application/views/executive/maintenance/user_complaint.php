								...
								<div class="table-responsive">
									<table id="tabeldatahere" class="table table-striped text-center display nowrap">
										...
										<tbody>
										  ...
										  <?php 
										  foreach($requeest_service as $service)
										  {
											?>

											<tr>
												<td><?php echo $service['name'] ?></td>
												<td><?php echo $service['pro_name'] ?></td>
												<td><?php echo $service['room_no'] ?></td>
												<td><?php echo $service['complaints_type'] ?></td>
												...
												<td><?php 
												 ...
												 switch($service['status'])
													...
													case 2:
													?>
													<a class="badge badge-danger" href="#" >rejected</a>
													<?php
													break;
												...
												<td class="">
													...
													<a class="badge badge-info p-2" href="<?php echo base_url('executive/request/complaints/resolve/').$service['complaint_id']; ?>">Resolve</a>
