...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url("assets/front/"); ?>css/upanel.css" />
					...
					<div class="ps-top__right">
						<div class="ps-language-currency">
						   <?php
								...
								<a class="ps-dropdown-value dropdown-toggle " href="javascript:void(0);" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <?php echo $curuser['name'];  ?></a>
								<div class="dropdown-menu mdm" aria-labelledby="dropdownMenuLink" >
								   <a class="dropdown-item" href="<?php echo base_url('user/front');  ?>">Home</a>
									<a class="dropdown-item" href="<?php echo base_url('user/front/myprofile');  ?>">Profile</a>
									<a class="dropdown-item" href="#">My Bookings</a>
									<a class="dropdown-item" href="<?php echo BASE_HTTP_REL_URL; ?>user/UserLogin/logout">Logout</a>
								</div>
							...
							<a class="ps-dropdown-value" href="javascript:void(0);" data-toggle="modal" data-target="#popupSignin">Sign In</a>
							<?php
								}
								?>
							<a class="ps-dropdown-value dropdown-toggle " href="javascript:void(0);" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Career </a>
								<div class="dropdown-menu mdm" aria-labelledby="dropdownMenuLink" >
								   <a class="dropdown-item" href="<?php echo base_url("user/front/host/registration"); ?>" targeta="_blank"> List Your Property</a>
								   <a class="dropdown-item" href="<?php echo base_url('user/front/executive/registration');  ?>">Executive </a>
								   <a class="dropdown-item" href="<?php echo base_url('user/front/guard/registration');  ?>">Guard</a>
								</div>
				...
				<div class="container">
					...
					<div class="ps-header__right">
						...
						<div class="ps-header__search">
							<form action="<?php echo site_url("user/front/search"); ?>"  class="advance_search_frm" method="GET">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<select  class="form-control dropdown_filter" name="city" id="city_id">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<select class="form-control dropdown_filter" name="area" id="area_id">
														<option value=""></option>
													</select>
												</div>
											</div>
